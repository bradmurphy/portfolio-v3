        ...
        return (
            <section className="component-about">
                ...
                <p className="typography__copy typography__copy--light">
                    ...
                    with my dogs, Atlas & Siva. When we're not walking the city, you can usually find us grabbing some good eats or crashed out on the couch watching a the next netflix binge. And of course, last but not least -- jamming out to some good tunes!
                </p>
                <p className="typography__copy typography__copy--light">
